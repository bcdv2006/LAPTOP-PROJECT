...
//**************************************************************************
.define C_S530_Timer_Setting_X1		C_Timer_Setting_8K
.define C_S530_Timer_Setting_X2		C_Timer_Setting_16K
.define C_S530_Timer_Setting_X4		C_Timer_Setting_32K
...
.public  _USER_S530_SetStartAddr_Con
.public F_USER_S530_SetStartAddr_Con

.public F_USER_S530_GetData
.public  _USER_S530_Volume
.public F_USER_S530_Volume

.public F_SACM_S530_SendDAC1
.public F_SACM_S530_SendDAC2
.public F_SACM_S530_StartPlay
.public F_SACM_S530_EndPlay
.public F_SACM_S530_Init_
.public F_SACM_S530_DAC_Timer_X1
.public F_SACM_S530_DAC_Timer_X2
.public F_SACM_S530_GetStartAddr_Con
...
//****************************************************************
// Function    : F_SACM_S530_Init_
// Description : Hardware initilazation for S530, called by library
// Destory     : R1
// Parameter   : None
// Return      : None
// Note        : None
//****************************************************************
F_SACM_S530_Init_:	.proc
	FIR_MOV OFF;
	
	R1 = C_TimerA_FPLL;				// TimerA CKA=Fosc/2 CKB=1 Tout:off
	[P_Timer_Ctrl] = R1;
	R1= C_S530_Timer_Setting_X1;	// TimerA setting
	[P_TimerA_Data] = R1;
	[P_TimerA_CNTR] = R1;
...
// Note        : None
//****************************************************************
 _USER_S530_Volume: .proc
	R1 = SP + 3;
	R1 = [R1];								// volume index
F_USER_S530_Volume:
	R1 += T_SACM_S530_Volume_Level;		// loop up volume table
	R1 = [R1];
...
//****************************************************************
// Function    : F_SACM_S530_DAC_Timer_X1
...
// Note        : None
//****************************************************************
 _SACM_S530_DAC_Timer_X1:	.proc
F_SACM_S530_DAC_Timer_X1:
	R1 = C_S530_Timer_Setting_X1;
	[P_TimerA_Data] = R1;
	retf;
	.endp

//****************************************************************
// Function    : F_SACM_S530_DAC_Timer_X2
// Description : Set timer for S530 playback, called by library
// Destory     : R1
// Parameter   : None
// Return      : None
// Note        : None
//****************************************************************
 _SACM_S530_DAC_Timer_X2:	.proc
F_SACM_S530_DAC_Timer_X2:
	push R1 to [SP];
	R1 = C_S530_Timer_Setting_X2;
	[P_TimerA_Data] = R1;
	pop R1 from [SP];
	retf;
	.endp
...
// Note        : None
//****************************************************************
F_SACM_S530_SendDAC1:	.proc
    [P_DAC_CH1_Data] = R4;
	retf;
	.endp

//****************************************************************
// Function    : F_SACM_S530_SendDAC2
...
// Note        : None
//****************************************************************
F_SACM_S530_SendDAC2:	.proc
    [P_DAC_CH2_Data] = R4;
	retf; 
	.endp

//****************************************************************
// Function    : F_SACM_S530_StartPlay
...
// Note        : None
//****************************************************************
F_SACM_S530_StartPlay:	.proc
	nop;
	retf;
	.endp

//****************************************************************
// Function    : F_SACM_S530_EndPlay
...
// Note        : None
//****************************************************************
F_SACM_S530_EndPlay:	.proc
	nop;
	retf;
	.endp

//****************************************************************
// Function    : F_USER_S530_SetStartAddr
...
@
//****************************************************************
// Function    : F_USER_S530_SetStartAddr_Con
// Description : This API allows users to set the beginning address
//               to fetch data. This address can be either a ROM address
//               or a external storage address. User would have to modify
//               the function body based on the application's need.
...
// Note        : None
//****************************************************************
_USER_S530_SetStartAddr_Con:	.proc
	R1 = SP + 3;
	R1 = [R1];

F_USER_S530_SetStartAddr_Con:
	push R2 to [SP];
...
@
//****************************************************************
// Function    : F_SACM_S530_GetStartAddr_Con
// Description : 
// Destory     : None
// Parameter   : 
// Return      : None
// Note        : None
//****************************************************************
F_SACM_S530_GetStartAddr_Con:	.proc
	R1 = [R_ExtMem_Low_Con];
