...
R1 = C_TimerA_FPLL;				// TimerA CKA=Fosc/2 CKB=1 Tout:off
	[P_Timer_Ctrl] = R1;
	R1= C_DVR4800_Timer_Setting_X2;	// TimerA setting
	[P_TimerA_Data] = R1;
	[P_TimerA_CNTR] = R1;
...
F_USER_DVR4800_Volume:
	R1 += T_SACM_DVR4800_Volume_Level;		// loop up volume table
	R1 = [R1];
	call F_SACM_DVR4800_Volume;
	retf
	.endp
