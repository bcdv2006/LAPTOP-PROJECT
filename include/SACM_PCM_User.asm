...
.public  _USER_PCM_SetStartAddr_Con
.public F_USER_PCM_SetStartAddr_Con
...
.public F_SACM_PCM_GetStartAddr_Con
...
@	
//****************************************************************
// Function    : F_USER_PCM_SetStartAddr_Con
// Description : This API allows users to set the beginning address
//               to fetch data. This address can be either a ROM address
//               or a external storage address. User would have to modify
//               the function body based on the application's need.
...
// Note        : None
//****************************************************************
_USER_PCM_SetStartAddr_Con:	.proc
	R2 = SP + 3;
	R1 = [R2++];
	R2 = [R2];
F_USER_PCM_SetStartAddr_Con:
	push R1, R3 to [SP];
	R3 = [_Mode];
	jz ?L_PlayPrerecordData;
?L_PlayRecordedData:
...
//****************************************************************
// Function    : F_SACM_PCM_GetStartAddr_Con
// Description : 
// Destory     : None
// Parameter   : 
// Return      : None
// Note        : None
//****************************************************************
F_SACM_PCM_GetStartAddr_Con:	.proc
	R1 = [R_ExtMem_Low_Con];
