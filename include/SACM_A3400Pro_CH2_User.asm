...
.include A3400Pro_CH2.inc


//**************************************************************************
// Table Publication Area
//**************************************************************************
.public D_IO_EVENT_CH2_NUM 
.public D_SW_PWM_CH2_LEVEL
.public T_IO_Event_CH2


//***************************************************************************************
// User Definition Section for IO Event
//***************************************************************************************
.define C_IO_EVENT_CH2_NUM    3                      // IO number for IO_Event 
.define C_SW_PWM_CH2_FREQ     60                     // PWM frequency (Unit: Hz)
.define C_SW_PWM_CH2_LEVEL    128                    // PWM level selection (32/64/128/256)
.define C_PWM_CH2_FREQ        65536 - (SystemClock / (C_SW_PWM_CH2_FREQ * C_SW_PWM_CH2_LEVEL))      // for PWM Service Timer Setting
...
.define C_RING_BUFFER2_LEN              200  // Define ring buffer length
...
//**************************************************************************
.public  _USER_A3400Pro_CH2_SetStartAddr
.public F_USER_A3400Pro_CH2_SetStartAddr
.public  _USER_A3400Pro_CH2_SetSA_Con
.public F_USER_A3400Pro_CH2_SetSA_Con
.public F_USER_A3400Pro_CH2_GetData
.public  _USER_A3400Pro_CH2_Volume
.public F_USER_A3400Pro_CH2_Volume
.public F_SACM_A3400Pro_CH2_SendDAC1
.public F_SACM_A3400Pro_CH2_SendDAC2
.public F_SACM_A3400Pro_CH2_StartPlay
.public F_SACM_A3400Pro_CH2_EndPlay
.public F_SACM_A3400Pro_CH2_INT_ON
.public F_SACM_A3400Pro_CH2_INT_OFF
.public F_SACM_A3400Pro_CH2_Init_
.public F_SACM_A3400Pro_CH2_DAC_Timer_X1
.public F_SACM_A3400Pro_CH2_DAC_Timer_X2
.public F_SACM_A3400Pro_CH2_GetStartAddr_Con
.public F_Event_CH2_Init_
.public F_GetExtSpeechStartAddr_CH2
.public F_USER_GetEvtData_CH2
.public F_USER_IoEvtStart_CH2
.public F_USER_IoEvtEnd_CH2
.public F_USER_EvtProcess_CH2
.public  _USER_A3400Pro_CH2_ServiceLoop
.public F_USER_A3400Pro_CH2_ServiceLoop
.public  _InitRingBuffer_CH2
.public F_InitRingBuffer_CH2


//**************************************************************************
// Variable Publication Area
//**************************************************************************
.public R_DutyArray_CH2 
...
//**************************************************************************
.RAM
.var R_ExtMem_Low_CH2
.var R_ExtMem_High_CH2
.var R_ExtMem_Low_Con_CH2
.var R_ExtMem_High_Con_CH2
.var R_SPI_Addr_Low_CH2
.var R_SPI_Addr_High_CH2
.var R_SignFlag

R_SACM_Ring_Buffer2:    .dw    C_RING_BUFFER2_LEN    dup(?)
.var    R_RingBuffer2WrPtr                                 
.var    R_RingBuffer2RdPtr 

R_DutyArray_CH2:    .dw    C_IO_EVENT_CH2_NUM    dup(?)  
...
D_IO_EVENT_CH2_NUM:
.DW C_IO_EVENT_CH2_NUM

D_SW_PWM_CH2_LEVEL:
.DW C_SW_PWM_CH2_LEVEL
...
//*****************************************************************************
// Function    : F_SACM_A3400Pro_CH2_Init_
...
// Note        : None
//*****************************************************************************
F_SACM_A3400Pro_CH2_Init_:	.proc
	FIR_MOV OFF;
	...
	R1 = C_DAC_Enable | C_DAC_CH1_Enable | C_DAC_CH1_Up_Sample_Enable | C_DAC_CH1_TMR_Sel_TimerA;
	R1 |= C_DAC_CH2_Enable | C_DAC_CH2_TMR_Sel_TimerA;
	[P_DAC_Ctrl] = R1;		
    ...
    //
    R1 = R_SACM_Ring_Buffer2;  
    [R_RingBuffer2WrPtr] = R1;
    [R_RingBuffer2RdPtr] = R1; 
...
//*****************************************************************************
// Function    : F_USER_A3400Pro_CH2_Volume
...
// Note        : None
//*****************************************************************************
 _USER_A3400Pro_CH2_Volume: .proc
	R1 = SP + 3;
	R1 = [R1];								// volume index
F_USER_A3400Pro_CH2_Volume:
	R1 += T_SACM_A3400Pro_Volume_Level;		// loop up volume table
	R1 = [R1];
	call F_SACM_A3400Pro_CH2_Volume;
	retf
	.endp

//*****************************************************************************
// Function    : F_SACM_A3400Pro_CH2_DAC_Timer_X1
...
// Note        : None
//*****************************************************************************
 _SACM_A3400Pro_CH2_DAC_Timer_X1:	.proc
F_SACM_A3400Pro_CH2_DAC_Timer_X1:
	R1 = C_A3400Pro_Timer_Setting_X1;
	[P_TimerA_Data] = R1;
	retf;
	.endp
...
//*****************************************************************************
// Function    : F_SACM_A3400Pro_CH2_DAC_Timer_X2
...
// Note        : None
//*****************************************************************************
 _SACM_A3400Pro_CH2_DAC_Timer_X2:	.proc
F_SACM_A3400Pro_CH2_DAC_Timer_X2:
	push R1 to [SP];
...
//*****************************************************************************
// Function    : F_SACM_A3400Pro_CH2_SendDAC1
...
// Note        : None
//*****************************************************************************
F_SACM_A3400Pro_CH2_SendDAC1:	.proc
	[P_DAC_CH1_Data] = R4;	
	retf;
	.endp

//*****************************************************************************
// Function    : F_SACM_A3400Pro_CH2_SendDAC2
...
// Note        : None
//*****************************************************************************
F_SACM_A3400Pro_CH2_SendDAC2:	.proc
    [P_DAC_CH2_Data] = R4;
	retf; 
	.endp

//*****************************************************************************
// Function    : F_SACM_A3400Pro_CH2_StartPlay
...
// Note        : None
//*****************************************************************************
F_SACM_A3400Pro_CH2_StartPlay:	.proc
	nop;
	retf;
	.endp

//*****************************************************************************
// Function    : F_SACM_A3400Pro_CH2_EndPlay
...
// Note        : None
//*****************************************************************************
F_SACM_A3400Pro_CH2_EndPlay:	.proc
	nop;
	retf;
	.endp

//*****************************************************************************
// Function    : F_SACM_A3400Pro_CH2_INT_ON
...
// Note        : None
//*****************************************************************************
F_SACM_A3400Pro_CH2_INT_ON:	.proc
	FIQ on;
	retf;
	.endp

//*****************************************************************************
// Function    : F_SACM_A3400Pro_CH2_INT_OFF
// Description : This function called by library
// Destory     : None
// Parameter   : None
// Return      : None
// Note        : None
//*****************************************************************************
F_SACM_A3400Pro_CH2_INT_OFF:	.proc
	FIQ off;
	retf;
	.endp

//*****************************************************************************
// Function    : F_USER_A3400Pro_CH2_SetStartAddr
...
// Note        : None
//*****************************************************************************
_USER_A3400Pro_CH2_SetStartAddr:	.proc
	R1 = SP + 3;
	R1 = [R1];

F_USER_A3400Pro_CH2_SetStartAddr:
	push R1, R2 to [SP];
...
//*****************************************************************************
// Function    : F_USER_A3400Pro_CH2_SetSA_Con
// Description : This API allows users to set the beginning address
//               to fetch data. This address can be either a ROM address
//               or a external storage address. User would have to modify
//               the function body based on the application's need.
...
// Note        : None
//*****************************************************************************
_USER_A3400Pro_CH2_SetSA_Con:	.proc
	R1 = SP + 3;
	R1 = [R1];

F_USER_A3400Pro_CH2_SetSA_Con:
	push R2 to [SP];
	...
	R2 = 0x0000;
	call F_SPI_ReadAWord;
	[R_ExtMem_Low_Con_CH2] = R1;
	
	pop R1 from [SP];
	R1 += 2;
	call F_SPI_ReadAWord;	
	[R_ExtMem_High_Con_CH2] = R1;
...
//*****************************************************************************
// Function    : F_SACM_A3400Pro_CH2_GetStartAddr_Con
// Description : 
// Destory     : None
// Parameter   : 
// Return      : None
// Note        : None
//*****************************************************************************
F_SACM_A3400Pro_CH2_GetStartAddr_Con:	.proc
	R1 = [R_ExtMem_Low_Con_CH2];
	R2 = [R_ExtMem_High_Con_CH2];
	[R_ExtMem_Low_CH2] = R1;
	[R_ExtMem_High_CH2] = R2;
	retf;
	.endp

//*****************************************************************************
// Function    : F_USER_A3400Pro_CH2_GetData
...
// Note        : None
//*****************************************************************************
F_USER_A3400Pro_CH2_GetData:	.proc
    R2 = [R_RingBuffer2RdPtr];    
    R1 = [R2++];                                      
    cmp R2, R_SACM_Ring_Buffer2 + C_RING_BUFFER2_LEN;
    jb ?L_StoreRingBufferRdPtr;                       
    R2 = R_SACM_Ring_Buffer2;                          
?L_StoreRingBufferRdPtr:                              
    [R_RingBuffer2RdPtr] = R2; 	
	retf;
	.endp
...
//*****************************************************************************
// Function    : F_GetExtSpeechStartAddr_CH2
...
// Note        : None
//*****************************************************************************
F_GetExtSpeechStartAddr_CH2:	.proc	
	R1 = [R_ExtMem_Low_CH2];	
	R2 = [R_ExtMem_High_CH2];
	retf
	.endp
...
// Description : This function will fill R_SACM_Ring_Buffer2 with 
...
// Note        : 
//*****************************************************************************
_USER_A3400Pro_CH2_ServiceLoop:    .proc
F_USER_A3400Pro_CH2_ServiceLoop:    
    push R1, R5 to [SP];
    
    call F_SACM_A3400Pro_CH2_Status;
    R2 = R1 & C_SACM_A3400Pro_PLAY;
    jz ?_USER_A3400Pro_CH2_ServiceLoop_End
    R2 = R1 & C_SACM_A3400Pro_AUTO;
    jz ?L_Fill_RingBuffer;  
    
?_USER_A3400Pro_CH2_ServiceLoop_End:
	pop R1, R5 from [SP]; 
	retf;      

?L_Fill_RingBuffer:    
    R1 = [R_RingBuffer2WrPtr];
    R2 = [R_RingBuffer2RdPtr];
    cmp R2, R1;
    je ?_USER_A3400Pro_CH2_ServiceLoop_End;
    cmp R2, R1;
...
?L_Fill_RingBuffer_1:
    R2 = R2 - R1;
	R3 = [R_SPI_Addr_Low_CH2];	
	R4 = [R_SPI_Addr_High_CH2];		
	...
	R3 += R2 lsl 1;
	R4 += 0, carry;
	[R_SPI_Addr_Low_CH2] = R3;
	[R_SPI_Addr_High_CH2] = R4; 	
	
	pop R1, R5 from [SP]; 
	retf;

?L_Fill_RingBuffer_2:		
    R2 += C_RING_BUFFER2_LEN
    R2 -= R1;
    R5 = R2;
    R2 = R_SACM_Ring_Buffer2 + C_RING_BUFFER2_LEN;    
    R2 -= R1;    
	R3 = [R_SPI_Addr_Low_CH2];
	R4 = [R_SPI_Addr_High_CH2];		
	call F_SPI_ReadNWords;	
...
//*****************************************************************************
_InitRingBuffer_CH2:    .proc
F_InitRingBuffer_CH2:    
    push R1 to [sp];
