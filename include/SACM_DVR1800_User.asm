...
//**************************************************************************
.define C_DVR1800_Timer_Setting_X1		C_Timer_Setting_16K
.define C_DVR1800_Timer_Setting_X2		C_Timer_Setting_32K
.define C_DVR1800_Timer_Setting_X4		C_Timer_Setting_64K
...
.public  _USER_DVR1800_SetStartAddr_Con
.public F_USER_DVR1800_SetStartAddr_Con

.public F_USER_DVR1800_GetData
.public F_USER_DVR1800_WriteData
.public  _USER_DVR1800_Volume
.public F_USER_DVR1800_Volume

.public F_SACM_DVR1800_SendDAC1
.public F_SACM_DVR1800_SendDAC2
.public F_SACM_DVR1800_GetADC
.public F_SACM_DVR1800_StartPlay
.public F_SACM_DVR1800_EndPlay
.public F_SACM_DVR1800_StartRecord
.public F_SACM_DVR1800_EndRecord
.public F_SACM_DVR1800_Init_
.public F_SACM_DVR1800_DAC_Timer_X1
.public F_SACM_DVR1800_DAC_Timer_X2
.public F_SACM_DVR1800_ADC_Timer_X1
.public F_SACM_DVR1800_ADC_Timer_X2
.public F_SACM_DVR1800_ADC_Timer_X4
.public F_SACM_DVR1800_GetStartAddr_Con
...
F_SACM_DVR1800_Init_:	.proc
	...
	[P_Timer_Ctrl] = R1;
	R1= C_DVR1800_Timer_Setting_X2;	// TimerA setting
	[P_TimerA_Data] = R1;
	[P_TimerA_CNTR] = R1;
...
//****************************************************************
// Function    : F_USER_DVR1800_Volume
...
// Note        : None
//****************************************************************
 _USER_DVR1800_Volume: .proc
	R1 = SP + 3;
	R1 = [R1];								// volume index
F_USER_DVR1800_Volume:
	R1 += T_SACM_DVR1800_Volume_Level;		// loop up volume table
	R1 = [R1];
	call F_SACM_DVR1800_Volume;
	retf
	.endp

//****************************************************************
// Function    : F_SACM_DVR1800_DAC_Timer_X1
...
// Note        : None
//****************************************************************
 _SACM_DVR1800_DAC_Timer_X1:	.proc
F_SACM_DVR1800_DAC_Timer_X1:
	R1 = C_DVR1800_Timer_Setting_X1;
	[P_TimerA_Data] = R1;
	retf;
	.endp

//****************************************************************
// Function    : F_SACM_DVR1800_DAC_Timer_X2
// Description : Set timer for DVR1800 playback, called by library
// Destory     : R1
// Parameter   : None
// Return      : None
// Note        : None
//****************************************************************
 _SACM_DVR1800_DAC_Timer_X2:	.proc
F_SACM_DVR1800_DAC_Timer_X2:
	push R1 to [SP];
	R1 = C_DVR1800_Timer_Setting_X2;
	[P_TimerA_Data] = R1;
	pop R1 from [SP];
	retf;
	.endp
...
//****************************************************************
// Function    : F_SACM_DVR1800_ADC_Timer_X1
...
// Note        : None
//****************************************************************
 _SACM_DVR1800_ADC_Timer_X1:	.proc
F_SACM_DVR1800_ADC_Timer_X1:
	R1 = C_DVR1800_Timer_Setting_X1;
	[P_TimerA_Data] = R1;
	retf;
	.endp
...
//****************************************************************
// Function    : F_SACM_DVR1800_ADC_Timer_X2
// Description : Change timer setting for change AD filter, called by library
// Destory     : R1
// Parameter   : None
// Return      : None
// Note        : None
//****************************************************************
 _SACM_DVR1800_ADC_Timer_X2:	.proc
F_SACM_DVR1800_ADC_Timer_X2:
	R1 = C_DVR1800_Timer_Setting_X2;
	[P_TimerA_Data] = R1;
	retf;
	.endp
...
//****************************************************************
// Function    : F_SACM_DVR1800_ADC_Timer_X4
// Description : Set timer for DVR1800 recording, called by library
// Destory     : R1
// Parameter   : None
// Return      : None
// Note        : None
//****************************************************************
 _SACM_DVR1800_ADC_Timer_X4:	.proc
F_SACM_DVR1800_ADC_Timer_X4:
	push R1 to [SP];
	R1 = C_DVR1800_Timer_Setting_X4;
	[P_TimerA_Data] = R1;
	pop R1 from [SP];
	retf;
	.endp
...
// Note        : None
//****************************************************************
F_SACM_DVR1800_StartPlay:	.proc
	nop;
	retf;
	.endp

//****************************************************************
// Function    : F_SACM_DVR1800_EndPlay
...
//****************************************************************
// Function    : F_USER_DVR1800_SetStartAddr
...
@
//****************************************************************
// Function    : F_USER_DVR1800_SetStartAddr_Con
// Description : This API allows users to set the beginning address
//               to fetch data. This address can be either a ROM address
//               or a external storage address. User would have to modify
//               the function body based on the application's need.
...
// Note        : None
//****************************************************************
_USER_DVR1800_SetStartAddr_Con:	.proc
	R2 = SP + 3;
	R1 = [R2++];
	R2 = [R2];
F_USER_DVR1800_SetStartAddr_Con:
	push R1, R3 to [SP];
	R3 = [_Mode];
	jz ?L_PlayPrerecordData;
?L_PlayRecordedData:
...
@
//****************************************************************
// Function    : F_SACM_DVR1800_GetStartAddr_Con
// Description : 
// Destory     : None
// Parameter   : 
// Return      : None
// Note        : None
//****************************************************************
F_SACM_DVR1800_GetStartAddr_Con:	.proc
	R1 = [R_ExtMem_Low_Con];
