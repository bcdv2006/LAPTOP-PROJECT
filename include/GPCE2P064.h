//==========================================================================
// File Name   : GPCE2P064.H
// Description : GPCE2P064 registers and constants definition
// Written by  : Caspar Chi
// Last modified date:
//              2011/11/22
//==========================================================================
//#ifndef __GPCE2P064_H__
//#define __GPCE2P064_H__
...
#define P_IO_Ctrl				0x2008		// Modified
...
//---------------------------------------------------
#define P_PWM_Ctrl				0x2020		// Modified
...
//---------------------------------------------------
#define P_DAC_Ctrl				0x2040		// Modified
#define P_DAC_CH1_Data			0x2041		// Modified
...
#define	C_DAC_Enable				0x1000		// Voltage DAC Enable
...
#define	C_DAC_CH2_Enable			0x0400		// Data Channel 2 Enable
...
#define	C_DAC_CH1_Enable			0x0004		// Data Channel 1 Enable 
...
// For Enable Push-pull,  1.Enable NMOS  -> 2.Delay 10us -> 3.Enable PMOS
// For Disable Push-pull, 1.Disable PMOS -> 2.Delay 10us -> 3.Disable NMOS
...
#define C_PP_Gain_LV0			0x0000		//Default
